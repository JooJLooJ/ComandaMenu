...
if (isset($_POST['submit'])) {
    ...
    $sqlFoto = "SELECT fotoCatAlimento FROM categoriaalimento WHERE idCatAlimento = $idCat";
    ...
    $sqlCat = "UPDATE categoriaalimento SET nomeCatAlimento = '$nomeCat', fotoCatAlimento = '$foto' WHERE idCatAlimento = $idCat";
...
<head>
    ...
    <link rel="stylesheet" href="css/style_edt_cat.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>    <link rel="icon" type="image/png" href="https://64.media.tumblr.com/d923e8a07f53a626fa8a3015fdaee3ac/79b89c18e8e1c8de-83/s1280x1920/0f79e0016d2d04ff8957b976391e625e77dc91cc.pnj"/>
    ...
    <div class="row linha1">
        ...
        <div class="row linha2">
            ...
            <div class="row linha_comida">
                    ...
                    <div class="texto1 col-9">Editar categoria</div>
                </div>
                <div class="row mb-3">
                    <?php
...
<form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row linhanome_interface2 mb-3">
                            ...
                            <input type="text" class="form-control inputs" name="nome" value="<?php echo $rowCat['nomeCatAlimento'] ?>">
                        </div>
